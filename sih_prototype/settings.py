"""
Django settings for sih_prototype project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','auxiliumai.pythonanywhere.com', '192.168.0.101']
...
ROOT_URLCONF = 'sih_prototype.urls'
...
WSGI_APPLICATION = 'sih_prototype.wsgi.application'
